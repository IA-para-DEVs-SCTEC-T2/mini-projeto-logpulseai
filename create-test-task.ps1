# Script PowerShell para criar tarefa de testes no GitHub via CLI

$title = "Testes: Validar estrutura do projeto e dependências (Task 1)"

$body = @"
## Testes: Validar estrutura do projeto e dependências
...
gh issue create --title $title --body $body --label "test,enhancement" --assignee "@me"

Write-Host "✅ Issue de testes criada com sucesso!" -ForegroundColor Green
